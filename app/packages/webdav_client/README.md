# webdav_client (Ultrasend vendored fork)

> Based on [flymzero/webdav_client](https://pub.dev/packages/webdav_client) @ 1.2.1 with local bugfixes (PROPFIND/XML namespace parsing, auth, etc.). Do not publish to pub.dev.
